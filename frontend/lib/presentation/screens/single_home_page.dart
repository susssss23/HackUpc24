...
import 'package:my_web_app/presentation/screens/deprecated_home_page.dart';


class SingleHomePage extends StatefulWidget {
  final ControladorPresentacio controladorPresentacio;

  const SingleHomePage({Key? key, required this.controladorPresentacio}) : super(key: key);

  @override
  State<SingleHomePage> createState() => _SingleHomePageState(controladorPresentacio);
}

class _SingleHomePageState extends State<SingleHomePage> {
  ...
  _SingleHomePageState(ControladorPresentacio controladorPresentacio) {
      ...
      appBar: AppBar(
        ...
        leading: Container(
          ...
          child: RawMaterialButton(
            fillColor: Color.fromARGB(255, 216, 185, 222),
            elevation: 2.0,
            ...
            onPressed: () {
              Navigator.push(
                    ...
                    PageTransition(
                      ...
                      child: SecondHomePage(controladorPresentacio: _controladorPresentacio),
                    ),
                  );
            },
          ),
